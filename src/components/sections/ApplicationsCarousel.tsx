...
const images = [
  { src: '/images/applications/application-1.png', alt: 'Industrial Control Applications - Shenzhen Qiyang Electronics' },
  { src: '/images/applications/application-2.png', alt: 'Aerospace Applications - Shenzhen Qiyang Electronics' },
  { src: '/images/applications/application-3.png', alt: 'Communication Equipment Applications - Shenzhen Qiyang Electronics' },
  { src: '/images/applications/application-4.png', alt: 'Automotive Electronics Applications - Shenzhen Qiyang Electronics' },
  { src: '/images/applications/application-5.jpg', alt: 'Medical Equipment Applications - Shenzhen Qiyang Electronics' },
];
